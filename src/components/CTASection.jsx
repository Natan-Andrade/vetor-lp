      ...
      <div className="p-12 lg:p-24 relative z-10 text-center flex flex-col items-center">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-zinc-900 mb-4 tracking-tight">
            Pronto para ter um <span className="text-brand-500">sistema próprio?</span>
          </h2>
          <p className="text-zinc-600 text-sm mb-8">
            Chega de pagar mensalidades caras por sistemas genéricos. Desenvolvemos a sua Landing Page e o seu Sistema de Gestão exclusivos, sob medida para a realidade da sua marcenaria.
          </p>
